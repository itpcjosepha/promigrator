    ...
    <main className="min-h-screen bg-gradient-to-b from-gray-900 via-black to-gray-900 text-white">
      ...
      <section className="px-6 pt-24 pb-16 text-center">
        ...
        <p className="mt-6 text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto">
          Modern tools that bridge FileMaker with enterprise automation, CI/CD
          workflows, SQL Server, and PowerShell integrations.
        </p>
      ...
      <section className="px-6 pb-24">
        <div className="max-w-4xl mx-auto text-center mb-8">
          <h2 className="text-2xl md:text-3xl font-bold mb-2">
            Be first in line for Pro-Migrator releases
          </h2>
          <p className="text-gray-300 text-sm md:text-base">
            Sign up to get notified when 2FM-CD, 2SQL, and 2PS are ready for
            download, plus behind-the-scenes updates as the tools evolve.
          </p>
        </div>
        <EmailSignup />
      </section>
      ...
      <section id="products" className="px-6 py-20 max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-10">
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-6 backdrop-blur-lg hover:bg-white/10 transition group shadow-xl">
            <h3 className="text-2xl font-semibold mb-4">2FM-CD</h3>
            <p className="text-gray-300 text-sm leading-relaxed">
              Full SDLC automation for FileMaker. Deploy from DEV → QA → BETA →
              PROD using migration automation powered by the FM Admin API +
              FMDM.
            </p>
            <div className="mt-6">
          ...
          {/* 2SQL Card */}
          <div className="bg-white/5 border border-white/10 rounded-xl p-6 backdrop-blur-lg hover:bg-white/10 transition group shadow-xl">
            <h3 className="text-2xl font-semibold mb-4">2SQL</h3>
            <p className="text-gray-300 text-sm leading-relaxed">
              Export FileMaker schema + data directly into SQL Server. Perfect
              for analytics, reporting, Power BI, Tableau, and enterprise
              integrations.
            </p>
            <div className="mt-6">
          ...
          {/* 2PS Card */}
          <div className="bg-white/5 border border-white/10 rounded-xl p-6 backdrop-blur-lg hover:bg-white/10 transition group shadow-xl">
            <h3 className="text-2xl font-semibold mb-4">2PS</h3>
            <p className="text-gray-300 text-sm leading-relaxed">
              Free PowerShell execution toolkit for FileMaker Server. Create
              secure bat/ps job runners, generate PKI keys, and automate
              anything.
            </p>
            <div className="mt-6">
      ...
      <footer className="py-10 text-center text-gray-500 text-sm border-t border-white/10">
        <p>
          © {new Date().getFullYear()} Pro-Migrator • A division of AMDyno, Inc.
        </p>
        <p className="mt-2">
          Empowering FileMaker developers with enterprise-grade automation
          tools.
        </p>
      </footer>
    </main>
